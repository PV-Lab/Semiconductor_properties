%% SRH: advanced model (with bandgap narrowing, effective mass DOS, with effective mass vth)
...
function [tau_SRH,p1,n1] = SRH_full_adv(Nt,sigma_n,sigma_p,Ect,Etv,T,delta_n,N_dop,type)
